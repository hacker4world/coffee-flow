...
// Edit page for a single table. Reads the table id from the URL, pre-fills
// the form with the table's current data, and saves changes back to state.
const EditTablePage = () => {
  ...
  // If the table doesn't exist (e.g. bad URL), show a fallback instead of
      ...
      <div className="relative w-full max-w-md mx-auto bg-gradient-to-b from-stone-100 to-amber-100 min-h-screen shadow-xl flex flex-col">
        ...
        <main className="flex-1 px-4 py-6 pb-28">
          <div className="bg-white rounded-2xl shadow-sm ring-1 ring-stone-100 p-8 text-center">
            ...
            <p className="text-stone-500">{t("admin.tableNotFound")}</p>
          </div>
        </main>
      </div>
    );
